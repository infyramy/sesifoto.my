            ...
            <div className="p-5 flex flex-col h-full relative z-10">
                ...
                <div className="flex items-start gap-4 mb-4">
                    <div className="shrink-0 relative">
                        ...
                        <div className="absolute -bottom-1 -right-1 bg-white dark:bg-zinc-900 rounded-full px-1.5 py-0.5 border border-slate-100 dark:border-zinc-800 shadow-sm flex items-center gap-0.5">
                            <Star size={8} className="fill-amber-400 text-amber-400" />
                            <span className="text-[10px] font-bold text-slate-700 dark:text-slate-300">{studio.rating}</span>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-2 mt-auto">
                    ...
                    <div className="relative">
                        ...
                        {/* Navigate Popup */}
                        {isAddressActive && (
                            <div className="absolute bottom-full left-0 right-0 mb-2 bg-white dark:bg-zinc-900 border border-slate-200 dark:border-white/10 rounded-xl p-2 shadow-2xl z-30 animate-in slide-in-from-bottom-2 fade-in w-[180%] -ml-[40%] origin-bottom">
                                ...
                                <div className="grid gap-1.5">
                                    <a href={studio.addressLink} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-2 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 text-slate-700 dark:text-slate-200 text-xs font-bold transition-colors group/waze">
                    ...
                    <div className="relative">
                        ...
                        {isContactActive && (
                            <div className="absolute bottom-full left-0 right-0 mb-2 bg-white dark:bg-zinc-900 border border-slate-200 dark:border-white/10 rounded-xl p-2 shadow-2xl z-30 animate-in slide-in-from-bottom-2 fade-in w-[180%] -ml-[40%] origin-bottom">
                                ...
                                <div className="grid gap-1.5">
                                    <a href={studio.whatsapp} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-2 rounded-lg hover:bg-green-50 dark:hover:bg-green-900/20 text-slate-700 dark:text-slate-200 text-xs font-bold transition-colors group/wa">
                ...
                {/* Primary CTA */}
                <a
                    href={studio.whatsapp} // Assuming booking link is usually whatsapp or specific booking url
                    target="_blank"
                ...
                >
                    {language === 'en' ? 'Book Session' : 'Tempah Sesi'}
                </a>
            </div>
        </div>
    );
